...
!function(t, e, i) {
    ...
    L.Draw.Polyline = L.Draw.Feature.extend({
        ...
        completeShape: function() {
            this._markers.length <= 1 || (this._fireCreatedEvent(),
            this.disable(),
        ...
        _endPoint: function(e, i, o) {
            if (this._mouseDownOrigin) {
                ...
                this._finishShape()) : a < 10 && L.Browser.touch ? this._finishShape() : Math.abs(n) < 9 * (t.devicePixelRatio || 1) && this.addVertex(o.latlng),
        ...
        _drawGuide: function(t, e) {
            var i, o, n, a = Math.floor(Math.sqrt(Math.pow(e.x - t.x, 2) + Math.pow(e.y - t.y, 2))), s = this.options.guidelineDistance, r = this.options.maxGuideLineLength, l = a > r ? a - r : s;
    ...
    L.Draw.Rectangle = L.Draw.SimpleShape.extend({
        ...
        _getTooltipText: function() {
            var t, e, i, o = L.Draw.SimpleShape.prototype._getTooltipText.call(this), n = this._shape, a = this.options.showArea;
    ...
    L.Edit.PolyVerticesEdit = L.Handler.extend({
        ...
        addHooks: function() {
            ...
            e && t.options.editing.className && (t.options.original.className && t.options.original.className.split(" ").forEach(function(t) {
        ...
        _initMarkers: function() {
            ...
            for (t = 0,
            e = i - 1; t < i; e = t++)
                (0 !== t || L.Polygon && this._poly instanceof L.Polygon) && (a = this._markers[e],
                s = this._markers[t],
    ...
    L.Map.TouchExtend = L.Handler.extend({
        ...
        removeHooks: function() {
            ...
            L.DomEvent.off(this._container, "MSPointerCancel", this._onTouchCancel)) : (L.DomEvent.off(this._container, "touchcancel", this._onTouchCancel),
    ...
    function() {
        ...
        L.GeometryUtil = L.extend(L.GeometryUtil || {}, {
            ...
            readableArea: function(e, i, o) {
                ...
                n = e >= 1e6 && -1 !== a.indexOf("km") ? L.GeometryUtil.formattedNumber(1e-6 * e, o.km) + " km²" : e >= 1e4 && -1 !== a.indexOf("ha") ? L.GeometryUtil.formattedNumber(1e-4 * e, o.ha) + " ha" : L.GeometryUtil.formattedNumber(e, o.m) + " m²") : (e /= .836127,
    ...
    L.Toolbar = L.Class.extend({
        ...
        addToolbar: function(t) {
            var e, i = L.DomUtil.create("div", "leaflet-draw-section"), o = 0, n = this._toolbarClass || "", a = this.getModeHandlers(t);
        ...
        _createActions: function(t) {
            ...
            for (var l = 0; l < r; l++)
                "enabled"in s[l] && !s[l].enabled || (e = L.DomUtil.create("li", "crntli", a),
